...
# Source File: ADUserResetPassword_v1.0.psproj
#------------------------------------------------------------------------
#region Project Recovery Data (DO NOT MODIFY)
<#RecoveryData:
#>
#endregion
<#
    .NOTES
...
.NOTES
    ...
    Version  : 1.0 
    Changelog:
        - 1.0 (2016-01-03) Initial version.
.LINK
...
ZMbZ9RgnJ0lvlRUscEjtCLm9DOO13a6kfy3Z+R/xYd7oPCkAAA==#>
	...
	$FormMain_Load =
	{
		...
		$global:SSALogFile = New-Item -ItemType File -Path "$env:USERPROFILE\Documents" -Name "SSA_ADResetUserPassword_$SSALogFileTimeStamp.log"
